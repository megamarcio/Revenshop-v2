-- Recria a tabela reservations do zero com apenas os campos necessários
-- Remove a tabela antiga e cria uma nova com estrutura limpa

-- Primeiro, remove a tabela existente (se existir)
DROP TABLE IF EXISTS reservations CASCADE;

-- Cria a tabela reservations com estrutura correta para dados customizados
