...
const FinancingInfoForm = ({
  ...
  const calculateInterestRate = () => {
    ...
    if (financedAmount > 0 && installmentValue > 0 && totalInstallments > 0) {
      ...
      const monthlyRate = Math.pow(totalPayment / financedAmount, 1.0 / totalInstallments) - 1;
  ...
  // Calcular taxa mensal para o tooltip
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Taxa de juros aproximada mensal: {calculateMonthlyRate()}%</p>
                    </TooltipContent>
                  </Tooltip>
                  <Input 
                    id="interestRate"
